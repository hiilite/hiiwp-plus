...
/**
 * HiiWP_Plus_Settings Class
 *
 * @class HiiWP_Plus_Settings
 * @version	1.0.0
 * @since 1.0.0
 * @package	HiiWP_Plus
 * @author Jeffikus
 */
final class HiiWP_Plus_Settings {
	/**
	...
	/**
	 * Main HiiWP_Plus_Settings Instance
	 *
	 * Ensures only one instance of HiiWP_Plus_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @return Main HiiWP_Plus_Settings instance
	 */
