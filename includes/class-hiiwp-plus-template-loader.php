 ...
 *
 * @package   HiiWP_Plus_Template_Loader
 * @author    Peter Vigilante
 * @copyright 2018 Hiilite Creative Group Inc.
 * @license   GPL-2.0+
 * @version   1.0.0
 */

if ( ! class_exists( 'HiiWP_Plus_Template_Loader' ) ) {
	 ...
	 * @author  Gary Jones
	 */
	class HiiWP_Plus_Template_Loader {
		/**
		 ...
		 * @var string
		 */
		protected $plugin_directory = HIIWP_PLUS_PLUGIN_DIR;
